        ...
        try:
            ...
            while _alt != 2 and _alt != ATN.INVALID_ALT_NUMBER:
                if _alt == 1:
                    ...
                    if la_ == 1:
                        localctx = SlimParser.MulDivContext(self,
                                                            SlimParser.ExprContext(self, _parentctx, _parentState))
                        ...
                        localctx = SlimParser.SumResContext(self,
                                                            SlimParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 49
                        ...
                        localctx = SlimParser.ExponentialContext(self,
                                                                 SlimParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 52
